import {buildRoute, createSimplyServer, NotFoundError} from "simply-served"
...
export const createAgritimeServer = (rooms: Map<string, Room>, io: Server) =>
  createSimplyServer<ServerCtx>({
    initContext: {db: {rooms}, io},
    getAuth: () => {
      // No auth required. And no db either, rooms are ephemeral.
      return {}
    },
